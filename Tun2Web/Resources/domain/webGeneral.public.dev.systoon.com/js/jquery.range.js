...
(function($, window, document, undefined) {
    ...
    jRange.prototype = {
        ...
        template: '<div class="slider-container" id="cizhi">\
			<div class="back-bar">\
                <div class="selected-bar"></div>\
                <div class="pointer low"></div><div class="pointer-label"></div>\
                <div class="pointer high iconfont"></div><div class="pointer-label">0</div>\
        ...
        setValue: function(value) {
            ...
            if(window.inits){
                if(inits.styleFlag){
                    if(inits.styleFlag == 0){
                        value = value ? value : inits.old_opac*100;
                    }else if(inits.styleFlag == 3){
                        value = value ? value : inits.old_size;
                    }
                }
            }
